...
| [02-game-selection.svg](./02-game-selection.svg) | Game selection - Voice Racer + Voice Bubble Popper cards, 1 "coming soon" | US-02 |
| [03-mic-permission.svg](./03-mic-permission.svg) | Microphone permission modal + denied fallback note | US-05 |
| [04-game-playing.svg](./04-game-playing.svg) | Main game (Voice Racer) - target word, lane words, listening pill | US-03, US-04 |
| [05-game-feedback.svg](./05-game-feedback.svg) | Success feedback - "GREAT!" banner, car in the matched lane | US-06 |
...
3. Switch the right panel to the **Prototype** tab and drag connection arrows:
   ...
   - `04 Game playing` -> the ROCKET lane sign (simulates saying the word) -> `05 Game feedback`
...
> Note: in the real product the lane change in step `04 -> 05` is triggered by **voice** (Web Speech API), not by click; the click hotspot only simulates a correct pronunciation in the prototype.
